...
export default function FinalCTA() {
  return (
    <section className="py-32 md:px-10">
      <div className="max-w-7xl mx-auto">

        <div className="relative rounded-3xl overflow-hidden border border-[#5CE1E6]/20 bg-[#050a0a] dark:bg-[#050a0a] p-12 md:p-20">
          ...
          <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto gap-8">
            ...
            <div className="flex flex-col items-center gap-5">
              ...
              <h2 className="text-[clamp(2.2rem,5vw,3.8rem)] font-extrabold leading-[1.1] tracking-[-0.03em] text-white">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              ...
              <Link
                href="/about-us"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl border border-white/15 text-white/70 font-semibold text-sm hover:border-[#5CE1E6]/50 hover:text-white transition-all duration-200 w-full sm:w-auto justify-center"
              >
