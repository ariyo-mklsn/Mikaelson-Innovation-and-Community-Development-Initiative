...
export const ecosystems = [
  {
    ...
    bullets: [
      ...
      "Consistency is doing the right thing even when no one is watching.",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Commitment is the decision to keep going even when motivation fades.",
      "Progress is the evidence that your consistency is compounding over time.",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Courage is choosing to act rightly even when it costs you something.",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Growers are people who embrace feedback, learn from failure, and evolve every single day.",
    ],
